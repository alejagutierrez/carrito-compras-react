        ...
        <tbody>
            {
                listaCompras.map(item =>(
                    <tr key={item.id}>
                        ...
                        <td>{item.price}</td>
                        <td>
                            <button className='btn btb-ouline-primary' onClick={() => aumentarCantidad(item.id)}>+</button>
                            <button className='btn btb-primary'>{item.cantidad}</button>
                            <button className='btn btb-ouline-primary' onClick={() => disminuirCantidad(item.id)}>-</button>
                        </td>
                        <td>
